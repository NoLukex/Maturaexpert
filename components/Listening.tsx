...
type TaskType = 'true_false' | 'matching' | 'choice';

interface ListeningQuestion {
  id: number;
  text: string;
  options?: string[]; // For choice
  correctAnswer: string | number; // 'True'/'False' or index or matching letter
}
...
interface ListeningTask {
  ...
  matchingOptions?: string[]; // Specifically for matching tasks (A-E)
}
...
const LISTENING_TASKS: ListeningTask[] = [
  {
    ...
    type: 'true_false',
    description: 'Usłyszysz rozmowę z chłopakiem, który pracuje jako wolontariusz. Zdecyduj, które zdania są zgodne z treścią nagrania (T), a które nie (F).',
    script: `
  ...
  },
  {
    ...
    type: 'matching',
    description: 'Usłyszysz cztery wypowiedzi na temat gotowania. Do każdej wypowiedzi (1-4) dopasuj odpowiadające jej zdanie (A-E). Jedno zdanie zostało podane dodatkowo.',
    script: `
  ...
  },
  {
    ...
    type: 'choice',
    description: 'Usłyszysz komunikat na lotnisku. Z podanych odpowiedzi wybierz właściwą.',
    script: `
  ...
  },
  {
    ...
    type: 'matching',
    description: 'Usłyszysz cztery osoby mówiące o technologii. Dopasuj zdania (A-E) do osób (1-4).',
    script: `
  ...
  {
    id: 'l5',
    title: 'Zadanie 5. Przyjęcie',
    type: 'true_false',
    description: 'Usłyszysz rozmowę Alice i Marka o przyjęciu urodzinowym. Oceń prawdziwość zdań.',
    script: `
  ...
  },
  {
    ...
    type: 'choice',
    description: 'Usłyszysz historię o wakacjach. Wybierz poprawną odpowiedź.',
    script: `
